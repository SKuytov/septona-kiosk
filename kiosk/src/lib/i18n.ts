...
const STRINGS = {
  bg: {
    ...
    keyboard: 'Клавиатура на екрана',
    keyboardSwitch: 'Смени азбуката',
    backspace: 'Изтрий знак',
    space: 'Интервал',
    clear: 'Изчисти',
    done: 'Готово',
    ...
    engineFailedHint:
      'Файлът е наличен и цял, но програмата за преглед не успя да го разчете. Задръжте логото 3 сек. и стартирайте «Диагностика» — проверката показва версията на WebView на устройството.',
    service: 'Сервизен режим',
    fullscreen: 'Цял екран',
    exitFullscreen: 'Изход от цял екран',
    showList: 'Покажи списъка',
    hideList: 'Скрий списъка',
    ...
    homeHint: 'Изберете категория, за да видите документите',
    homeAction: 'Докоснете категория горе',
    home: 'Начало',
  ...
  en: {
    ...
    keyboardSwitch: 'Switch alphabet',
    ...
    engineFailedHint:
      'The file is present and complete, but the viewer could not read it. Hold the logo for 3 s and run Diagnostics — it reports this device\'s WebView version.',
    ...
    homeTitle: 'Welcome',
    homeHint: 'Choose a category to see its documents',
    homeAction: 'Touch a category above',
    home: 'Home',
