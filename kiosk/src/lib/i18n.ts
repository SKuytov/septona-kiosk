...
const STRINGS = {
  bg: {
    ...
    pages: 'стр.',
    loading: 'Зареждане…',
    preparing: 'Подготовка на документите…',
    localContent: 'Локални документи',
    ...
    openFailedHint: 'Локалното копие е повредено. Задръжте логото 3 сек. и стартирайте «Диагностика» в сервизния екран.',
  ...
  en: {
    ...
    openFailedHint: 'The local copy is damaged. Hold the logo for 3 s and run Diagnostics on the service screen.',
